...
const comediansCards = document.querySelector('#comedians-cards');
...
function showComedians(howMany = comedians.length, startFrom = 0) {
  for (let i = startFrom; i < howMany; i += 1) {
    ...
    const biography = document.createElement('h4');
...
const lessBtn = document.querySelector('#load-less-btn');
